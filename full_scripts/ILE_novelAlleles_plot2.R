...
print("L19251_I6_S6_001_PRIMER-S5_R1 \n")

# Load sample
DF <- read_airr(paste0(path, "dedup-mpg_L19249_I6_S6_001_PRIMER-S5_R1_igblast_db-pass_parse-select_parse-select.tsv"))
...
ggsave(paste0(plots_path, "I6_S6_PRIMER-S5_IGHV1-5-01_A73G_A87C_A159T_G162C_C249T.svg"), plot = last_plot(), device = NULL, path = NULL, width = 20, height = 20, units = "cm")
...
ggsave(paste0(plots_path, "I6_S6_PRIMER-S5_IGHV1-69-01_T226G.svg"), plot = last_plot(), device = NULL, path = NULL, width = 20, height = 20, units = "cm")
...
ggsave(paste0(plots_path, "I6_S6_PRIMER-S5_Genotype.svg"), plot = last_plot(), device = NULL, path = NULL, width = 20, height = 40, units = "cm")
...
writeFasta(gtseq, paste0(path, "results_tigger/mpg_L19249_I6_S6_001_PRIMER-S5_R1_vgenotype.fasta"))
...
# Store
write_airr(sample_db, paste0(path, "results_tigger/mpg_L19249_I6_S6_001_PRIMER-S5_R1_genotype_airr.tsv"))
