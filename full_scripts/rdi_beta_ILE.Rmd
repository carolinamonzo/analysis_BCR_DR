...
for (i in 1:length(list_iso)){
  ...
  write.table(df_d_new, file = paste0("../../analysis/results_tables/RDI_", list_iso[[i]], "_biogroup_ILE_isosum.tsv"), append = TRUE, col.names = TRUE, row.names = TRUE)
}
```
...
for (i in 1:length(list_iso)){
  ...
  df_d_new <- data.frame(df_d)
  # Save the dataframe to plot in python
  write.table(df_d_new, file = paste0("../../analysis/results_tables/RDI_", list_iso[[i]], "_samp_ILE_isosum.tsv"), append = TRUE, col.names = TRUE, row.names = TRUE)
}
```
...
df_d_new <- data.frame(df_d)
# Save the dataframe to plot in python
write.table(df_d_new, file = paste0("../../analysis/results_tables/RDI_samp_ILE.tsv"), append = TRUE, col.names = TRUE, row.names = TRUE)
```



```{r}
metadata <- data.frame(sample_id = db$sample_id, biogroup = db$biogroup, both = paste(db$sample_id, db$biogroup), pal = "", stringsAsFactors = FALSE)
...
labels_colors(euc_dend) <- c("24DR_lifelong"="#AD1E22", "20AL_lifelong"="#6897C6", "20DR_lifelong"="#DD694D", "20DR_lifelong"="#DD694D", "24AL_lifelong"="#3D64A8", "5DR_lifelong"="#ECBAA1",  "24DR_lifelong"="#AD1E22", "16AL_lifelong"="#A2C2DD", "20AL_lifelong"="#6897C6", "24DR_lifelong"="#AD1E22", "5DR_lifelong"="#ECBAA1",  "5DR_lifelong"="#ECBAA1",  "5DR_lifelong"="#ECBAA1",  "20AL_DR16M"="#779D45",    "5AL_lifelong"="#D3E0F1",  "5DR_lifelong"="#ECBAA1",  "24DR_lifelong"="#AD1E22", "24AL_lifelong"="#3D64A8", "5AL_lifelong"="#D3E0F1",  "24AL_lifelong"="#3D64A8", "20AL_DR16M"="#779D45",    "24AL_DR16M"="#416F6F",    "5AL_lifelong"="#D3E0F1",  "24AL_DR16M"="#416F6F",    "20AL_DR16M"="#779D45",    "20AL_DR16M"="#779D45",    "20AL_lifelong"="#6897C6", "24AL_lifelong"="#3D64A8", "5AL_lifelong"="#D3E0F1",  "20DR_lifelong"="#DD694D", "24AL_DR20M"="#EDD853",    "24AL_lifelong"="#3D64A8", "5AL_lifelong"="#D3E0F1",  "20AL_lifelong"="#6897C6", "20DR_lifelong"="#DD694D", "16AL_lifelong"="#A2C2DD", "24AL_DR20M"="#EDD853",    "24AL_DR20M"="#EDD853",    "24AL_DR16M"="#416F6F",    "16AL_lifelong"="#A2C2DD", "16AL_lifelong"="#A2C2DD", "24AL_DR16M"="#416F6F",    "20AL_lifelong"="#6897C6", "24AL_DR16M"="#416F6F",    "24DR_lifelong"="#AD1E22", "24AL_DR20M"="#EDD853",    "20DR_lifelong"="#DD694D", "24AL_DR20M"="#EDD853",    "20AL_DR16M"="#779D45",    "16AL_lifelong"="#A2C2DD")
plot(euc_dend)
```
...
ggsave("../../analysis/plots/RDI_pcoa_ILE.svg", plot = last_plot(), device = NULL, path = NULL, width = 8, height = 8, units = "cm")
```
...
df_d_new <- df_d_new[df_d_new$row == df_d_new$col, ]
# Save the dataframe to plot in python
write.table(df_d_new, file = "../../analysis/results_tables/RDI_biogroups_ILE.tsv", append = TRUE, col.names = TRUE, row.names = TRUE)
```
